...
import com.hirecraft.jugunoo.passenger.adapter.TabsManagerPagerAdapter;
import com.hirecraft.jugunoo.passenger.adapter.TabsManagerPagerAdapter;
import com.hirecraft.jugunoo.passenger.fragments.ChangePasswordActivity;

public class ProfileManagerActivity extends FragmentActivity implements
		ActionBar.TabListener, OnClickListener
{
	...
	private static final String TAG = ProfileManagerActivity.class
			.getSimpleName();
	LinearLayout titleL;
	...
	private TabsManagerPagerAdapter mAdapter;
	...
	private void SetActionBar()
	{
		...
		RelativeLayout l = new RelativeLayout(ProfileManagerActivity.this);
	...
	private void init()
	{
		actionBar = getActionBar();
		viewPager = (ViewPager) findViewById(R.id.pager);
		mAdapter = new TabsManagerPagerAdapter(getSupportFragmentManager());
	...
	public void onClick(View v)
	{
		...
		{
			case R.id.nav_iconL:
				startActivity(new Intent(ProfileManagerActivity.this,
						LandingPage.class));
