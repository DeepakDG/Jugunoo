...
import com.hirecraft.jugunoo.passenger.adapter.TabsManagingUserAdapter;
import com.hirecraft.jugunoo.passenger.fragments.ChangePasswordActivity;

public class ProfileManagerUserActivity extends FragmentActivity implements
	...
	private static final String TAG = ProfileManagerUserActivity.class
			.getSimpleName();
	LinearLayout titleL;
	...
	private TabsManagingUserAdapter mAdapter;
	...
	private void SetActionBar() {
		...
		RelativeLayout l = new RelativeLayout(ProfileManagerUserActivity.this);
	...
	private void init() {
		actionBar = getActionBar();
		viewPager = (ViewPager) findViewById(R.id.pager);
		mAdapter = new TabsManagingUserAdapter(getSupportFragmentManager());
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.nav_iconL:
			startActivity(new Intent(ProfileManagerUserActivity.this,
					LandingPage.class));
			ProfileManagerUserActivity.this.finish();
			break;
		...
		case R.id.barChangePwd:
			...
			startActivity(new Intent().setClass(
					ProfileManagerUserActivity.this,
