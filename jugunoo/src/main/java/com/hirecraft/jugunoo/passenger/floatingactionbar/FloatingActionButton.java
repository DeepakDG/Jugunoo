package com.hirecraft.jugunoo.passenger.floatingactionbar;
...
public class FloatingActionButton extends ImageButton
{
	...
	{
		mVisible = true;
		mColorNormal = getColor(R.color.material_green_button);
		mColorPressed = getColor(R.color.material_green_button_pressed);
		...
		if (attr != null)
		{
			try
			{
				mColorNormal = attr.getColor(
						...
						getColor(R.color.material_green_button));
				mColorPressed = attr.getColor(
						R.styleable.FloatingActionButton_fab_colorPressed,
						getColor(R.color.material_green_button_pressed));
	...
	private void updateBackground()
	{
		...
		{ android.R.attr.state_pressed }, createDrawable(mColorPressed));
		drawable.addState(new int[]
		{}, createDrawable(mColorNormal));
