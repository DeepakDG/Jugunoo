package com.hirecraft.jugunoo.passenger.hcui;
...
public class HireCraftSLideLayout extends LinearLayout {
    ...
    public HireCraftSLideLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HireCraftSLideLayout(Context context) {
        super(context);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        content.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                return HireCraftSLideLayout.this.onContentTouch(v, event);
            }
        });
