package com.hirecraft.jugunoo.passenger.ui;
...
public class UiUtils {
	...
	public static void waitForLayoutPrepared(final View view,
			final LayoutPreparedListener listener) {
			...
			viewTreeObserver
					.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
						...
						private void removeGlobalOnLayoutListenerIfNeeded() {
							final ViewTreeObserver laterViewTreeObserver = view
									.getViewTreeObserver();
							if (laterViewTreeObserver != null
									&& laterViewTreeObserver.isAlive()) {
								laterViewTreeObserver
